<div class="wrap">
    ...
    <ul class="nav nav-tabs">
        <li class="<?php echo !isset($_POST["edit_widget"]) ? 'active' : '' ?>"><a href="#tab-1">Your Custom Widgets</a></li>
        <li class="<?php echo isset($_POST["edit_widget"]) ? 'active' : '' ?>">
            <a href="#tab-2">
                <?php echo isset($_POST["edit_widget"]) ? 'Edit' : 'Add' ?> Custom Widget
            </a>
        </li>
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_widget"]) ? 'active' : '' ?>">
            ...
            <h3>Manage Your Custom Widgets</h3>
...
<!--                                <input type="hidden" name="edit_widget" value="--><?php //echo $option['post_type']; ?><!--">-->
...
//                    submit_button();
        ...
        <div id="tab-3" class="tab-pane">
            <h3>Export Your Custom Widgets</h3>
        </div>
    </div>
</div>
<form id="ultimate-testimonial-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
    ...
    <div class="field-container">
        <input type="text" class="field-input" placeholder="Your Email" id="email" name="email">
        <small class="field-msg error" data-error="invalidEmail">The Email is Required</small>
    </div>
